...
# Pfad zum Ordner und Bilddatei
ordner_pfad = 'Pictures'
bild_datei = 'Picture 4.jpg'  # Name der Bilddatei im Ordner
...
if bild is None:
    ...
    cv2.imshow("Gefundene Objekte ohne Kinder mit Bounding-Boxen", ergebnisbild)
